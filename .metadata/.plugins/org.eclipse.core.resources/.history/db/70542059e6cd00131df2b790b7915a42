...
public class Level0 extends Level {
	...
	public Level0(Framework framework) {
		super(framework, new Scene12(framework), new Scene02(framework), new Scene03(framework), new Scene04(framework), new Scene05(framework), new Scene06(framework), new Scene07(framework), new Scene08(framework), new Scene09(framework), new Scene10(framework), new Scene11(framework));
